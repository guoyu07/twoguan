                               ...
                               <tr>
                                <td>
                                    ...
                                    if($v['roleid']!=1)
                                      {
                                        ?>
                                    <input class="rolename pl5"  name="rolename[<?php echo $v['roleid'];?>]" value="<?php echo $v['rolename'];?>" size="20"/>
                                    <?php
                                      }
                                      else
                                        echo $v['rolename'];
                                ...
                                <td>
                                    ...
                                    if($v['roleid']!=1)
                                    {
                                    ?><input class="pl5" name="description[<?php echo $v['roleid'];?>]" value="<?php echo $v['description'];?>" size="60"/>
                                    <?php
                                    }
                                    else
                                    echo $v['description'];
                                    ?></td>
                                <td align="center">
                                   <a href="javascript:;" onclick="goModify(<?php echo $v['roleid'];?>,this)"><?php if($v['roleid']!=1) echo Common::getIco('edit');?></a>
                                   &nbsp;&nbsp;&nbsp;
                                   <a href="javascript:;" onclick="delRow(this,<?php echo $v['roleid'];?>)"><?php if($v['roleid']!=1)   echo Common::getIco('del');  ?></a>
                                </td>
                               </tr>
                            <?php
                               }
