...
>
                  ...
                  <div class="rowElem" style="margin-top: 30px;">
                      <label>默认首页效果：</label>
                      <input type="radio"  name="cfg_index_templet" value="index_1.htm" <?php if($config['cfg_index_templet']=='index_1.htm') { ?>checked<?php } ?>
>
                      <label>效果一</label>
                      <input type="radio"  name="cfg_index_templet" value="index_2.htm" <?php if($config['cfg_index_templet']=='index_2.htm') { ?>checked<?php } ?>
>
                      <label>效果二</label>
                  </div>
