...
><label for="alipaytype0">即时到帐交易接口</label>
 ...
 value="double"><label for="alipaytype1">双功能</label></span>
                      ...
                      <tr name="weixinpay" style="display: none;">
                          <td class="titletd" colspan="2"><span class="fl">请使用ftp上传证书到/shouji/public/thirdpay/weixinpay/WxPayPubHelper/cacert目录下</span><br><img src="<?php echo $GLOBALS['cfg_public_url'];?>images/wxpay.png" alt="示例图片"/></td>
                      </tr>
