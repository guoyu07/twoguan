...
<table class="content-tab">
    ...
    <div class="content-nr">
      ...
      <div class="content-nr">
        <form id="configfrm">
         <div class="w-set-con">
        <div class="w-set-tit bom-arrow"><span class="on"><s></s>邮箱发送设置</span></div>
          <div class="w-set-nr">
            ...
            <a class="save ml-10" href="javascript:;" id="btn_save">保存</a>
             <!-- <a class="cancel" href="#">取消</a>-->
              ...
              <a class="save ml-10" href="javascript:;" id="testmail">发送测试邮件</a>
            </div>
            <img src="<?php echo $GLOBALS['cfg_public_url'];?>images/emailshili.jpg" alt="示例图片"></img>
          </div>
        </div>
        </form>
      </div>
