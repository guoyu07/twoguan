               ...
               <span class="display-mdd">
                  ...
                  <a href="javascript:void(0);" onClick="togMod(this,11,'结伴目的地')"<?php  if($typeid==11) echo 'class="on"';   ?>>结伴</a>
                   <?php $n=1; if(is_array($addmodule)) { foreach($addmodule as $row) { ?>
                      <a href="javascript:void(0);" onClick="togMod(this,<?php echo $row['id'];?>,'<?php echo $row['modulename'];?>目的地')"<?php  if($typeid==$row['typeid']) echo 'class="on"';   ?>><?php echo $row['modulename'];?></a>
                   <?php $n++;}unset($n); } ?>
                </span>
            </div>
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    overflowY:'scroll',
                                    layout:'fit',
                                    html:'<div class="product-add-div"><div class="add-class"><dl><dt>显示模版：</dt><dd style="width:auto;"><div class="temp-chg" id="templet_list"><a href="javascript:void(0) data-value="0" onclick="setTemplet(this,'+oid+')">标准</a> <?php $n=1; if(is_array($templetlist)) { foreach($templetlist as $r) { ?><a href="javascript:void(0)" data-value="<?php echo $r['path'];?>" onclick="setTemplet(this,'+oid+')"><?php echo $r['templetname'];?></a><?php $n++;}unset($n); } ?><input type="hidden" id="templet_'+oid+'" value="'+templet+'"></div></dd></dl></div></div>',
                                    listeners:{
                                        boxready:function(){
