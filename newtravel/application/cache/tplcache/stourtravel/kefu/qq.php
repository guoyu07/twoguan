...
<head>
    ...
    <?php echo Common::getScript('config.js,jquery.jqtransform.js');?>
</head>
<style>
                                ...
                                <div class="product-add-div">
                                    <div class="add-class">
                                        <dl>
                                            ...
                                            <dd>
                                                    <div class="on-off">
                                                        <input type="radio" id="" name="display" value="1" <?php if($display=='1') { ?>checked="checked"<?php } ?>
>
                                                        <label>开启</label>
                                                        <input type="radio" id="" name="display" value="0" <?php if($display=='0') { ?>checked="checked"<?php } ?>
>
                                                        <label>关闭</label>
                                                    </div>
                                            </dd>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                    <div class="on-off">
                                                        <input type="radio"  name="position" value="left" <?php if($pos=='left') { ?>checked="checked"<?php } ?>
>
                                                        <label>居左显示</label>
                                                        <input type="radio" name="position" value="right" <?php if($pos=='right') { ?>checked="checked"<?php } ?>
>
                                                        <label>居右显示</label>
                                                    </div>
                                            </dd>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="fl mr-30">
                                                    <span class="fl ml-5">左/右边距</span>&nbsp;&nbsp;<input type="text" style="margin-left: 5px;" name="posh" class="set-text-xh text_60 mt-2 ml-10" value="<?php echo $posh;?>">
                                                    <div class="help-ico mt-10 ml-5"></div>
                                                </div>
                                                <div class="fl">
                                                    <span class="fl">上边距</span>&nbsp;&nbsp;<input type="text" style="" name="post" value="<?php echo $post;?>" class="set-text-xh text_60 mt-2 ml-10">
                                                    <div class="help-ico mt-10 ml-5"></div>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl>
                                            ...
                                            <dd>
                                                <div class="fl mr-30">
                                                    <span class="fl ml-5"></span>&nbsp;&nbsp;<input type="text" style="margin-left: 5px;" name="phonenum" class="set-text-xh text_300 mt-2 ml-10" value="<?php echo $phonenum;?>">
                                                    <div class="help-ico mt-10 ml-5"></div>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl>
                                            ...
                                            <dd style="width: 790px;">
                                                    <ul class="kf-temp">
                                                        <li>
                                                            <p class="p1"><img src="<?php echo $GLOBALS['cfg_public_url'];?>/images/kf1.jpg" width="160" height="160" ></p>
                                                            <p class="p2">
                                                                <input type="radio" name="qqcl" value="1" <?php if($qqcl=='1') { ?>checked="checked"<?php } ?>
>
                                                                <label>客服模版1</label>
                                                            </p>
                                                        </li>
                                                        <li>
                                                            <p class="p1"><img src="<?php echo $GLOBALS['cfg_public_url'];?>/images/kf2.jpg" width="140" height="180" ></p>
                                                            <p class="p2">
                                                                <input type="radio" name="qqcl" value="2" <?php if($qqcl=='2') { ?>checked="checked"<?php } ?>
>
                                                                <label>客服模版2</label>
                                                            </p>
                                                        </li>
                                                       <li>
                                                            <p class="p1"><img src="<?php echo $GLOBALS['cfg_public_url'];?>/images/kf3.jpg" width="150" height="180" ></p>
                                                            <p class="p2">
                                                                <input type="radio" name="qqcl" value="3" <?php if($qqcl=='3') { ?>checked="checked"<?php } ?>
>
                                                                <label>客服模版3</label>
                                                            </p>
                                                        </li>
                                                        <!--<li>
                                                            ...
                                                            <p class="p2">
                                                                <input type="radio" name="qqcl" value="4" <?php if($qqcl=='4') { ?>checked="checked"<?php } ?>
>
                                                                <label>客服模版4</label>
                                                            </p>
                                                        </li>-->
