        ...
        <div class="manage-nr">
            <div class="message">
                ...
                <div class="box-830 msg-login">
                    ...
                    <form id="configfrm">
                    <div class="con-nr">
                        <label class="fl mr-20">授权帐号：<input type="text" name="cfg_sms_username" value="<?php echo $configinfo['cfg_sms_username'];?>" ></label>
                        <label class="fl">授权密码：<input type="password" name="cfg_sms_password" value="<?php echo $configinfo['cfg_sms_password'];?>" ></label>
                        <a class="" href="javascript:;" id="btn_save">保存</a>
                        <span>请填写思途 <em>官方网站</em> 会员帐号,密码。</span>
                    </div>
                    </form>
                </div>
                <div class="box-830 msg-jl">
                    <p>我的短信剩余条数<span><?php echo $leftmsg;?></span>条</p>
                    <div class="msg-day">
                        <span>使用记录<input type="text" id="uselog"  class="choosetime" >至今日</span>
                        <a href="javascript:;" class="querybtn" data-type="uselog" data-title="查询短信使用记录">查询</a>
                    </div>
                    <div class="msg-day">
                        <span>充值记录<input type="text" id="paylog" class="choosetime" >至今日</span>
                        <a href="javascript:;" class="querybtn" data-type="buylog" data-title="查询充值记录">查询</a>
                    </div>
                </div>
                <div class="box-830 msg-tc">
                    <div class="tit">
                        <p class="p1">短信购买套餐</p>
                        <p class="p2">当前短信库存<span><?php echo $totalnum;?></span>条</p>
                    </div>
                    <div class="con-list">
                        <dl>
                            <dt>A套餐</dt>
