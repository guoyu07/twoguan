    ...
    function () {
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'sitetemplet/index/action/read/site/<?php echo $webid;?>',  //读取数据的URL
                    update:  SITEURL+'sitetemplet/index/action/save/site/<?php echo $webid;?>',
                    destroy:  SITEURL+'sitetemplet/index/action/delete/site/<?php echo $webid;?>'
                },
                reader: 'json'
            },
            autoLoad: true,
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        return '<a href="javascript:;" onclick="config('+id+')">配置</a>';
                    }
                }
            ],
            plugins: [
...
function addSub(pid) {
    ...
    Ext.Ajax.request({
        method: 'post',
        url: SITEURL+'sitetemplet/index/action/addsub/site/<?php echo $webid;?>/',
        params: {pid: pid},
...
function updateField(ele,id,field,value,type)
{
    ...
    Ext.Ajax.request({
        url   :  SITEURL+"sitetemplet/index/action/update/site/<?php echo $webid;?>/",
        method  :  "POST",
        datatype  :  "JSON",
...
function config(id)
{
    ...
    var boxurl = SITEURL+'sitetemplet/config/webid/<?php echo $webid;?>/pageid/'+id;
    ST.Util.showBox('模板配置',boxurl,'580','400',function(){ },1);
}
$(function(){
    //子站切换点击
    var webid = $("#webid").val();
