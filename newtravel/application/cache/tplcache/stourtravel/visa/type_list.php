                ...
                <div class="content-nr">
                    <div class="w-set-con">
                        <div class="w-set-tit bom-arrow">
                            <?php echo  Stourweb_View::template('stourtravel/visa/kind_top');  ?>
                        </div>
                        <div class="w-set-nr">
                            ...
                            <div class="opn-btn">
                                <a class="save btn_save ml-10" href="javascript:;" onclick="saveType()">保存</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function getList()
    {
        $.getJSON(SITEURL+"visa/ajax_visatype_list","",function(data){
            ...
            $.each(trlist, function(i, trinfo){
                ...
                tr += '<td align="center" onclick="delType('+trinfo.id+',this)">'+delpic+'<input type="hidden" name="id[]" value="'+trinfo.id+'"/></td>';
