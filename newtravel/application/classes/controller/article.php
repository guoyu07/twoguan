	...
	public function action_article()
	{
		...
		else if($action=='read')    //读取列表
		{
			...
			if($sort[0]->property)
			{
                ...
                {
                    $order='order by a.templet '.$sort[0]->direction;
                }
			}
			$w="a.id is not null";
			...
			if(empty($kindid))
			{
			  $sql="select a.id,a.allow,a.aid,a.articlename,a.attrid,a.kind,a.kindlist,a.isindex,a.webid,a.addtime,a.ishidden,a.themelist,a.iconlist,b.isjian,b.displayorder,b.isding,a.modtime,a.templet from sline_article as a left join sline_allorderlist b on (a.id=b.aid and b.typeid=4) where $w $order limit $start,$limit";
			}
			else
			{
			   $sql="select a.id,a.allow,a.aid,a.articlename,a.attrid,a.kind,a.kindlist,a.isindex,a.webid,a.addtime,a.ishidden,a.themelist,a.iconlist,b.isjian,b.displayorder,b.isding,a.modtime,a.templet from sline_article as a left join sline_kindorderlist as b on (b.classid=$kindid and a.id=b.aid and b.typeid=4)  where $w $order limit $start,$limit";
