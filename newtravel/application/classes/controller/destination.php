    ...
    public function action_destination()
	{
		...
		else if($action=='read')
		{
		   ...
		   else
		   {
               ...
               $sql="select a.id,a.kindname,a.isopen,a.pinyin,a.iswebsite,{$bfields} from sline_destinations a left join $product_dest_table b on a.id=b.kindid where a.pid=$pid";
