...
class Controller_Advertise extends Stourweb_Controller{
    ...
    public function action_index()
    {
        ...
        else if($action=='read')    //读取列表
        {
            ...
            $sql="select a.*  from sline_advertise as a $w $order limit $start,$limit";
            //echo $sql;


            $totalcount_arr=DB::query(Database::SELECT,"select count(*) as num from sline_advertise a ")->execute()->as_array();
