  ...
  <div class="cms-main-box">
      ...
      <div class="cms-msg-box">
        ...
        <div class="txt-msg">
          ...
          <p class="version">我的版本： <span id="myversion"></span>&nbsp;&nbsp;&nbsp;&nbsp;<span id="newversion" style="display: none">发现新版本<a href="javascript:;" onclick="ST.Util.addTab('系统升级','{$cmsurl}upgrade/index/parentkey/application/itemid/1')">立即升级</a></span></p>
        </div>
      </div>
        ...
        <div class="pro-mge-con">
           ...
           {loop $menu['newproduct'] $v}
                <li>
                    ...
                    <p>
                        <a href="javascript:;" data-url="{$v['order']}" data-name="{$v['name']}订单">
                            <em>订单</em>
           ...
           {/loop}
                ...
                <li>
                    ...
                    <p>
                        <a href="javascript:;" data-url="order/index/parentkey/order/itemid/{$v['id']}/typeid/{$v['id']}" data-name="{$v['modulename']}订单">
                            <em>订单</em>
