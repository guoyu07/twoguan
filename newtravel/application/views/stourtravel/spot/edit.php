      ...
      <div class="content-nr">
          ...
          <div class="manage-nr">
              <div class="w-set-tit bom-arrow" id="nav">
                  ...
                  <span data-id="notice"><s></s>预订须知</span>
                      ...
                      <div class="add-class">
                          ...
                          <dl>
                              ...
                              <dd>
                                  ...
                                  <input type="button" class="btn-sum-xz mt-4" onclick="Product.Coordinates(700,500)" value="选择" />
                              </dd>
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="product-add-div" data-id="extend">
                      {php Common::genExtendData(5,$extendinfo);}
                  </div>
