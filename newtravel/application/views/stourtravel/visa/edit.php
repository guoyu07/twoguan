      ...
      <div class="content-nr">
          ...
          <div class="manage-nr">
              <div class="w-set-tit bom-arrow" id="nav">
                  ...
                  <span data-id="tupian"><s></s>签证图片</span>
                  <span data-id="jieshao"><s></s>签证介绍</span>
                  <span data-id="zhiliao"><s></s>所需资料</span>
                  <span data-id="xuzhi"><s></s>预订须知</span>
                  <span data-id="liucheng"><s></s>办理流程</span>
                  <span data-id="tishi"><s></s>温馨提示</span>
                      ...
                      <div class="add-class">
                          ...
                          <dl>
                              ...
                              <dd>
                                  ...
                                  <label style="cursor:pointer"><input class="fl mt-8 mr-3" type="radio" name="needinterview" value="1" {if $info['needinterview']==1} checked="checked"{/if}/><span class="fl">需要</span></label>
                              </dd>
                          </dl>
                          <dl>
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="product-add-div" data-id="zhiliao">
                      <ul class="subTitNav">
                  ...
                  <div class="product-add-div" data-id="xuzhi">
                      {php Common::getEditor('booknotice',$info['booknotice'],700,200);}
                  </div>
                  <div class="product-add-div" data-id="liucheng">
                      {php Common::getEditor('circuit',$info['circuit'],700,200);}
                  </div>
                  <div class="product-add-div" data-id="tishi">
                  ...
                  <div class="product-add-div" data-id="youhua">
                    ...
                    <div class="product-add-div" data-id="extend">
                        {php Common::genExtendData(8,$extendinfo);}
                   </div>
