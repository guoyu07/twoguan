...
<head>
    ...
    {php echo Common::getScript("uploadify/jquery.uploadify.min.js,product_add.js,st_validate.js,jquery.colorpicker.js,jquery.jqtransform.js,imageup.js,jquery.upload.js"); }
        ...
        <div class="content-nr">
            <div class="manage-nr">
                <div class="w-set-tit bom-arrow">
                    ...
                    ?>
                    <span id="column_attachment" onclick="Product.switchTab(this,'attachment')"><s></s>线路附件</span>
                    <span id="column_basic" onclick="Product.switchTab(this,'seo')"><s></s>优化设置</span>
                ...
                <div id="content_basic" class="product-add-div content-show">
                    ...
                    <div class="add-class">
                        ...
                        <dl>
                            <dt>图标设置：</dt>
                            <dd> <input type="button" class="btn-sum-xz mt-4" onclick="Product.getIcon(this,'.icon-sel')" value="选择"/>
                ...
                <div id="content_extend" class="product-add-div content-hide">
                    {php Common::genExtendData(1,$extendinfo);}
                </div>
