                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if(value=='add'){
                            ...
                            var html="<div style='vertical-align: bottom; height:30px;'><span style='float:left; display: block; right:20px; width:30px; '>"+
                                "<img style='vertical-align: bottom;' id='record_src_"+id+"' src="+value+"  height='20' border='0'></span>"+
...
function uploadlitpic(domid){
        $('#file_upload_'+domid).uploadify({
            ...
            'onUploadSuccess': function (file, data, response) {
                ...
                if(obj.bigpic!=''){
                    $('#record_src_'+domid).src=obj.bigpic;
                    //修改数据库
