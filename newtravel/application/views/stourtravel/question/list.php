...
<table class="content-tab">
    <tr>
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            ...
            <div id="product_grid_panel" class="content-nrt" style="margin-top: 50px;">
            ...
            columns: [
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' onclick=\"view(" + id + ")\">查看</a>";
                            html+= "&nbsp;&nbsp;"
                            html+= "<a href='javascript:void(0);' onclick=\"delS(" + id + ")\">删除</a>";
                        return html;
