...
<tr>
    ...
    <td valign="top" class="content-rt-td" style="overflow-x:hidden;">
        ...
        <div class="content-nr" style="height: 351px;">
            <div class="crumbs">
                <label>位置：</label>首页 &gt; 分类设置 &gt;{$channelname}设置  &gt; <span>内容介绍</span>
            </div>
            <div class="web-set">
                     ...
                     <form id="day_fm">
                        <table width="90%" border="0" cellspacing="0" cellpadding="0" id="day_tab">
                               <tr>
                                ...
                                <th scope="col" width="40%" align="center">分类名称</th>
                                <th scope="col" width="40%" align="center">字段名</th>
...
<script>
   ...
   $(".additem").click(function(){
       var url=SITEURL+"box/add_extend_field/typeid/{$typeid}";
       ST.Util.showBox('添加{$channelname}内容项',url,450,'',function(){window.location.reload()});
   });
