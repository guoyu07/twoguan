...
class Controller_Hotels extends Stourweb_Controller{
	...
	public function action_list()
	{
		...
		if(empty($city)){
			$w.=empty($key)?'':" and a.hotelname like '%{$key}%' ";
		}
		...
		if(!empty($room)){
			foreach ($room as $key => $value) {
				switch ($value['breakfirst']) {
					case '1':
						$room[$key]['breakfast'] = '含早餐';
						break;
					case '2':
						$room[$key]['breakfast'] = '含单早';
						break;
					case '3':
						$room[$key]['breakfast'] = '含双早';
						break;
					default:
						$room[$key]['breakfast'] = '无早餐';
						break;
				}
				switch ($value['computer']) {
					case '1':
						...
						break;
					case '2':
						$room[$key]['computer'] = '有线宽带';
						break;
					case '3':
						$room[$key]['computer'] = '无线宽带';
						break;
					default:
