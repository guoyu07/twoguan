...
class Controller_Tuan extends Stourweb_Controller{
    ...
    public function action_list()
    {
        ...
        {
           $sql="select a.* from sline_article as a left join sline_kindorderlist as b on (b.classid=$kindid and a.id=b.aid and b.typeid=13)  where $w $orderby limit $limit";
