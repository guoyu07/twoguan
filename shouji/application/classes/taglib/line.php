...
class Taglib_Line {
   ...
   */
    public static function getLine($params)
    {
        ...
        {
            $sql = "select a.* from sline_line a left join sline_allorderlist b on (a.id=b.aid and b.typeid=1) order by ifnull(b.displayorder,9999) asc,a.modtime desc,a.addtime desc limit {$limit},{$row}";
